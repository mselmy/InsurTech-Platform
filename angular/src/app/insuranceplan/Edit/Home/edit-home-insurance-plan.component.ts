...
@Component({
  ...
  styleUrls: ["./edit-home-insurance-plan.component.css"], // Fixed the property name styleUrls
})
export class EditHomeInsurancePlanComponent implements OnInit, OnDestroy {
  public EditObj: EditHomeinsuranceModule = new EditHomeinsuranceModule(
    0,
    0,
    0,
    0,
  ...
  ngOnInit(): void {
    ...
    // Initialize the form with empty values or default values from EditObj
    this.Edithomeform = new FormGroup({
      YearlyCoverage: new FormControl(this.EditObj.YearlyCoverage, [
        Validators.required,
        Validators.min(0),
        Validators.max(1.7976931348623157e308),
      ]),
      InsuranceLevel: new FormControl(this.EditObj.Level, [
        Validators.required,
      ]),
      Quotation: new FormControl(this.EditObj.Quotation, [
        Validators.required,
        Validators.min(0),
        Validators.max(1.7976931348623157e308),
      ]),
      WaterDamage: new FormControl(this.EditObj.WaterDamage, [
        Validators.required,
        Validators.min(0),
        Validators.max(1.7976931348623157e308),
      ]),
      GlassBreakage: new FormControl(this.EditObj.GlassBreakage, [
        Validators.required,
        Validators.min(0),
        Validators.max(1.7976931348623157e308),
      ]),
      NaturalHazard: new FormControl(this.EditObj.NaturalHazard, [
        Validators.required,
        Validators.min(0),
        Validators.max(1.7976931348623157e308),
      ]),
      FiresAndExplosion: new FormControl(this.EditObj.FiresAndExplosion, [
        Validators.required,
        Validators.min(0),
        Validators.max(1.7976931348623157e308),
      ]),
      AttemptedTheft: new FormControl(this.EditObj.AttemptedTheft, [
        Validators.required,
        Validators.min(0),
        Validators.max(1.7976931348623157e308),
      ]),
