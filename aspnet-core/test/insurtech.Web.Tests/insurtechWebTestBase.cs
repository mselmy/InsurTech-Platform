...
using insurtech.Web.Startup;
using AngleSharp.Html.Dom;
using AngleSharp.Html.Parser;
using Microsoft.AspNetCore.Hosting;
using Shouldly;

namespace insurtech.Web.Tests
{
    public abstract class insurtechWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static insurtechWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(insurtechWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<insurtechDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<insurtechDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<insurtechDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<insurtechDbContext, Task<T>> func)
        {
            T result;
